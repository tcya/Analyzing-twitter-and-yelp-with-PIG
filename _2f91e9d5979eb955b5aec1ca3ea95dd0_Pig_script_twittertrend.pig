...
twitter  = LOAD 'file:///home/cloudera/pigin/Twitter_Test.json' USING JsonLoader('created_time:chararray, text:chararray, user_id:chararray, id:chararray, created_date:chararray');
...
twt_d1             = FILTER twt_samp BY created_date MATCHES 'Mon Oct 08 2012';
...
-- Save the data
STORE twt_d1dall_normed into '/home/cloudera/pigoutnew/twt_d1dall_normed';
